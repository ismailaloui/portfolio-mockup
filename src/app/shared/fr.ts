export const locale = {
  ...
  data: {
      'about': {
          'title': 'A propos',
          'jobTitle': "Développeur d'applications web (Full Stack )",
          'introductionOfMe': "Développeur web passionné par la création de sites et d'applications web innovantes. Bonne expérience en développement front-end et back-end. Intéressé par les nouvelles technologies et méthodes de travail. J'aime proposer des idées qui permettent d'améliorer les processus d'affaires.",
          'passionateAboutDevelopment':' Passionné par le développement',
          'mobility': 'Mobile sur la regions Occitanie',
          'years': 'ans',
          'graduation': "Master 2 Informatique",
          'myResearch': 'Recherche de contrat CDI',
          'researchDescription': "Toujours à la recherche de nouveaux défis .Je cherche une entreprise innovante et centrée sur l'utilisateur pour répondre au mieux aux besoins du client, de son idée à la livraison finale de son projet, ou participer à l'amélioration d'un projet existant.",
          'and':'et',
