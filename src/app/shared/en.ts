export const locale = {
  ...
  data: {
      'about': {
          'title': 'About',
          'jobTitle': 'Web application developer (Full Stack)',
          'introductionOfMe': 'Web developer passionate about creating innovative websites and web applications. Good experience in front-end and back-end development. Interested in new technologies and working methods. I like to come up with ideas that to permit to improve business processes.',
          ...
          'researchDescription': 'Always looking for new challenges.I am looking for an innovative and user-centric company to best meet the needs customer, from his idea to the final delivery of his project, or participate in the improvement of a project existing.',
          'and':'and',
